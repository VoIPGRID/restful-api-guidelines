...
| `string` | `email` | {RFC-5322}[RFC 5322] | `"example@example.com"`
| `string` | `idn-email` | {RFC-6531}[RFC 6531] | `"hello@bücher.example"`
| `string` | `hostname` | {RFC-1034}[RFC 1034] | `"www.example.com"`
...
| `string` | `uri` | {RFC-3986}[RFC 3986] | `"https://www.example.com/"`
...
| `string` | `iri-reference` | {RFC-3987}[RFC 3987] | `"/woman-winter-jackets/"`
...
| `string` | `iso-3166` | two letter country code -- see {ISO-3166-1-a2}[ISO 3166-1 alpha-2] | `"GB"`  *Hint:* It is `"GB"`, not `"UK"`.
