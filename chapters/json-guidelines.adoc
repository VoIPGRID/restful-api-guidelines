...
These guidelines provides recommendations for defining JSON data referring to
{RFC-7159}[RFC 7159] (which updates {RFC-4627}[RFC 4627]),
...
* [[id]]{id}: the identity of the object. If used, IDs must be opaque strings(UUIDv4)
